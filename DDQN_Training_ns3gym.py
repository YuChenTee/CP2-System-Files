...
def main():
    try:
        ...
        # Clear the CSV at the start
        with open("episode_metrics.csv", mode='w', newline='') as file:
            writer = csv.writer(file)
            writer.writerow(["episode", "total_reward", "avg_power", "avg_qos", "avg_prb", "epsilon"])
        ...
        for episode in range(n_episodes):
            ...
            with open("episode_metrics.csv", mode='a', newline='') as file:
                writer = csv.writer(file)
                writer.writerow([
                    episode + 1,
                    total_reward,
